defmodule DuckFeeder do
  ...
  defdelegate runtime_child_spec(meta_conn, source_name, duckdb, opts \\ []),
  ...
  defdelegate start_service(meta_conn, source_name, duckdb, opts \\ []),
    to: DuckFeeder.Runtime

  defdelegate start_stream(meta_conn, source_name, duckdb, opts \\ []),
    to: DuckFeeder.Runtime
