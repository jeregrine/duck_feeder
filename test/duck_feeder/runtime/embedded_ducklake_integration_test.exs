defmodule DuckFeeder.Runtime.EmbeddedDuckLakeIntegrationTest do
  ...
  setup do
    ...
    root = temp_dir!("embedded_ducklake_runtime")
    source_name = unique_name("embedded_runtime")
    ...
    catalog_postgres_url = create_postgres_database!(meta_postgres_url, catalog_database)
  ...
  test "embedded runtime uses repo/schemas config to mirror CDC into Postgres-backed DuckLake", %{
    source_conn: source_conn,
    meta_conn: meta_conn,
    source_postgres_url: source_postgres_url,
    meta_postgres_url: meta_postgres_url,
